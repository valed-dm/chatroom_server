...
//     const vuIndex = (__VU - 1) % roomAssignments.length;
//     const {room, users} = roomAssignments[vuIndex];
//
//     // Iterate through all rooms and users
//     for (const {room, users} of roomAssignments) {
//
...
//             console.log(`user ${user} of ${users.length}`)
//
